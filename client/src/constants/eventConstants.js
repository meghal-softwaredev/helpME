...
export const INDIVIDUAL_EVENT_DETAILS_REQUEST = "INDIVIDUAL_EVENT_DETAILS_REQUEST";
export const INDIVIDUAL_EVENT_DETAILS_SUCCESS = "INDIVIDUAL_EVENT_DETAILS_SUCCESS";
export const INDIVIDUAL_EVENT_DETAILS_FAIL = "INDIVIDUAL_EVENT_DETAILS_FAIL";
